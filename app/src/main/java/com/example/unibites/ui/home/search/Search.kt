...
package com.example.unibites.ui.home.search
...
import com.example.unibites.model.SearchCategoryCollection
import com.example.unibites.model.SearchRepo
import com.example.unibites.model.SearchSuggestionGroup
...
fun Search(
    ...
    UniBitesScaffold(
        ...
        UniBitesSurface(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
            Column {
...
private fun SearchBar(
    ...
    UniBitesSurface(
        color = UniBitesTheme.colors.uiFloated,
                ...
                if (searchFocused) {
                    IconButton(onClick = onClearQuery) {
                        Icon(
                            ...
                            tint = UniBitesTheme.colors.iconPrimary,
...
private fun SearchHint() {
    Row(
        ...
        Icon(
            ...
            tint = UniBitesTheme.colors.textHelp,
            contentDescription = stringResource(R.string.label_search)
        )
        Spacer(Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.search_unibites),
