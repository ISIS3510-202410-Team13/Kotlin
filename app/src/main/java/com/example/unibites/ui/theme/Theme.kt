...
package com.example.unibites.ui.theme
...
object UniBitesTheme {
    val colors: UniBitesColors
        @Composable
        get() = LocalUniBitesColors.current
}
...
class UniBitesColors(
    ...
    fun update(other: UniBitesColors) {
...
@Composable
fun ProvideUniBitesColors(
    colors: UniBitesColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalUniBitesColors provides colorPalette, content = content)
}

private val LocalUniBitesColors = staticCompositionLocalOf<UniBitesColors> {
    error("No ColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [UniBitesTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
