...
fun FilterChip(
    ...
    val backgroundColor by animateColorAsState(
        if (selected) UniBitesTheme.colors.brandSecondary else UniBitesTheme.colors.uiBackground,
    ...
    val textColor by animateColorAsState(
        if (selected) Color.Black else UniBitesTheme.colors.textSecondary,
        label = "text color"
    )
        ...
        val backgroundPressed =
            if (pressed) {
                Modifier.offsetGradientBackground(
                    UniBitesTheme.colors.interactiveSecondary,
                    200f,
                    0f
                )
            } else {
